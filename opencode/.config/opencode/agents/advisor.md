...
When you need official documentation, current information, or other internet research, delegate to the `discovery` subagent instead of using web tools directly. Give it a precise research brief and prefer official sources.
...
- **Documentation links**: Delegate to the `discovery` subagent to find and share official documentation, relevant guides, and reference material. Always prefer official sources.
